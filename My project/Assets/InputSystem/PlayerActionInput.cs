...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/InputSystem/PlayerActionInput.inputactions".
/// </summary>
/// <remarks>
...
public partial class @PlayerActionInput: IInputActionCollection2, IDisposable
{
    ...
    ~@PlayerActionInput()
    {
        UnityEngine.Debug.Assert(!m_PlayerAction.enabled, "This will cause a leak and performance issues, PlayerActionInput.PlayerAction.Disable() has not been called.");
    }
